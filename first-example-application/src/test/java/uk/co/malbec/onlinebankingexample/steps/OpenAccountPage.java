...
public interface OpenAccountPage {
    ...
    @OnlyRunWith({Portfolio.CurrentAccountOnly.class,  Portfolio.CurrentAndSaverAccounts.class})
    public class OpenCurrentAccountInTheList implements OpenAccountPage {
