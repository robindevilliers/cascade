...
import com.github.robindevilliers.welcometohell.wizard.expression.function.NowFunction;
...
public class ExpressionParserTest {
    ...
    public void allTests() throws Exception {
        ...
        test("breed ~ '[R][Oo][Tt][Tt][Ww][Ee][Ii][Ll][Ee][Rr]'", "{'breed': 'Rottweiler'}", true, null);
    }
